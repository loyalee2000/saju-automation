...
class SajuAnalyzer:
    ...
    def get_daewoon(self, year_gan_idx, month_gan_idx, month_ji_idx):
        ...
        # [Posteller Style] 0세부터 시작하여 10년 주기로 표시
        for i in range(10): 
            if is_forward:
            ...
            # [Posteller Logic corrected]
            # 대운수 그대로 시작. 윤희정(0세)은 대운수가 0이었음. 김현민(10세)은 대운수 10.
            age = start_age + (i * 10)
            
            # Calculate Gregorian Year (Posteller style)
            # age세 = 출생년도 + age
            current_start_year = base_year + age
