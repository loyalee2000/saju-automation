...
new_method = """    def get_result_json(self):
        ...
        # Strength (Expects DICT pillars_data, and Single Char Day Gan)
        strength_res = self._calculate_saju_strength(d_gc, pillars_data, ohaeng_cnt)
        
        # Yongsin (Expects DICT pillars_data unused?, and Single Char Day Gan)
...
if start_idx != -1:
    ...
    with open(target_file, "w", encoding="utf-8") as f:
        f.write(new_content)
    print("Fixed get_result_json logic V5.")
else:
